...
description: 'Control the look and feel of your documentation using docs.json'
icon: 'gear'
---

Every Mintlify site requires a `docs.json` file with its core configuration. See the [properties](#properties) below for details.
...
<ResponseField name="navigation" type="Navigation[]" required>
  An array of navigation groups and their pages
  <Expandable title="Navigation">
    ...
    The relative paths to the MDX files that serve as pages.
...
<ResponseField name="logo" type="string or object">
  Path to a logo image, or an object with separate "light" and "dark" mode logo paths
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  An array of links to display in the topbar
  <Expandable title="TopbarLink">
    ...
    The URL the button links to. Example: `https://mintlify.com/docs`
    </ResponseField>
...
<ResponseField name="topbarCtaButton" type="Call to Action">
  <Expandable title="Topbar Call to Action">
    ...
    `link` displays a button. `github` shows repository info including the star count.
    </ResponseField>
    <ResponseField name="url" type="string">
...
<ResponseField name="anchors" type="Anchor[]">
  An array of anchors with their `icon`, `color`, and `url`.
...
<ResponseField name="api" type="API">
  ...
  <Expandable title="API">
    <ResponseField name="baseUrl" type="string">
      The base URL for all API endpoints. If `baseUrl` is an array, users can toggle between multiple base URL options.
    </ResponseField>
    ...
    <ResponseField name="auth" type="Auth">
      <Expandable title="Auth">
        ...
        The default prefix for the authentication input field.

        For example, an `inputPrefix` of `AuthKey` pre-fills the authentication field with `AuthKey`.
        </ResponseField>
      </Expandable>
    </ResponseField>
...
<ResponseField name="openapi" type="string | string[]">
  A URL or relative path pointing to your OpenAPI file. Can also be an array for
  multiple files.
...
<ResponseField name="footerSocials" type="FooterSocials">
  An object of social media accounts where each key-value pair maps a platform to its URL.
...
<ResponseField name="feedback" type="Feedback">
  Configure feedback buttons on documentation pages
...
<ResponseField name="modeToggle" type="ModeToggle">
  ...
  <Expandable title="ModeToggle">
    <ResponseField name="default" type={'"light" or "dark"'}>
      Force light or dark mode for new users. When not set, defaults to the
...
<ResponseField name="backgroundImage" type="string">
  A background image displayed behind every page. See examples at
