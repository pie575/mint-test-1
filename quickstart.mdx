...
<AccordionGroup>
  <Accordion icon="copy" title="Clone your docs locally">
    During onboarding, you created a GitHub repository for your docs. You can find it in your [dashboard](https://dashboard.mintlify.com).
...
<AccordionGroup>
  <Accordion icon="github" title="Install our GitHub app">
    ...
    The GitHub app deploys your changes automatically — no manual deployment needed.
</Accordion>
...
<Accordion icon="rocket" title="Publish your docs">
  ...
  2. Your docs will be updated and live in moments!
</Accordion>
...
<Card title="Write content" icon="pen-to-square" href="/essentials/markdown">
  Learn MDX syntax and start creating your documentation.
</Card>
...
<Note>
  **Need help?** Check out our [full documentation](https://mintlify.com/docs) or join our [community](https://mintlify.com/community).
</Note>
