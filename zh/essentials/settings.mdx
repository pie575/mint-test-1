...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    <ResponseField name="url" type="string">
      点击按钮后跳转到的 URL。示例：`https://mintlify.com/docs`
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="api" type="API">
  ...
  <Expandable title="API">
    <ResponseField name="baseUrl" type="string">
      所有 API 端点的基础 URL。如果 `baseUrl` 是数组，则会启用多个基础 URL
      选项，用户可在它们之间切换。
    </ResponseField>
    ...
    <ResponseField name="auth" type="Auth">
      <Expandable title="身份验证">
        ...
        <ResponseField name="inputPrefix" type="string">
          ...
          例如，如果 `inputPrefix` 为 `AuthKey`，则身份验证字段的默认输入值将以 `AuthKey` 作为前缀。
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="演练场">
        <ResponseField name="mode" default="show" type="&#x22;show&#x22; | &#x22;simple&#x22; | &#x22;hide&#x22;">
          ...
          前往 [playground guides](/zh/api-playground/demo) 了解更多
        </ResponseField>
      </Expandable>
    </ResponseField>
